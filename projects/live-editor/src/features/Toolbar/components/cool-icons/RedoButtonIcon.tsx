...
interface RedoButtonIconProps extends React.SVGProps<SVGSVGElement> {
    className?: string
}
export const RedoButtonIcon = React.memo(
  ({ className, ...props }: RedoButtonIconProps) => {
    return (
      <svg
        width="24"
        height="24"
...
RedoButtonIcon.displayName = "RedoButtonIcon"
